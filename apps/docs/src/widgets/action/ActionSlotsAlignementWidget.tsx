...
export function ActionSlotsAlignementWidget({ className, ...props }: ComponentPropsWithRef<"div">) {
  const examples = [
    {
      element: <Action style={{ width: "150px" }} endIcon={<XIcon />} />,
      description: (
        <p>
    ...
    {
      element: <Action style={{ width: "150px" }} endSlot={<Action variant="solid" startIcon={<XIcon />} />} />,
      description: (
        <p>
    ...
    },
    {
      element: (
        <Action
          style={{ width: "150px" }}
          endSlot={<Action variant="solid" startIcon={<XIcon />} style={{ marginLeft: "auto" }} />}
        />
      ),
      description: (
        <p>
    ...
    {
      element: (
        <Action style={{ width: "150px" }} endSlot={<Action variant="solid" startIcon={<XIcon />} />}>
          Hey
        </Action>
      ),
      description: (
