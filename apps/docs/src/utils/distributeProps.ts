...
export function distributeProps<L1, L2, L3, L4>(
  l1: L1[],
  l2: L2[],
  l3: L3[],
  l4: L4[],
): Merge<Merge<Merge<L1, L2>, L3>, L4>[]; // prettier-ignore
export function distributeProps<L1, L2, L3, L4, L5>(
  l1: L1[],
  l2: L2[],
  l3: L3[],
  l4: L4[],
  l5: L5[],
): Merge<Merge<Merge<Merge<L1, L2>, L3>, L4>, L5>[]; // prettier-ignore
